package com.framework.util.json;
...
public class ObjectMapperUtils {
    ...
    private static final ObjectMapper MAPPER = new ObjectMapper(new JsonFactory(new JsonFactoryBuilder().configure(INTERN_FIELD_NAMES, false)))
    ...
    public static <T> List<T> fromJSONArray(@Nullable String json, Class<T> valueType) {
        if (json == null) {
            return null;
        }
        try {
