package com.framework.starter.grpc.client.inject;
...
/**
 * 功能概述
 * className:      GrpcClientBeanPostProcessor
 * package:        com.framework.starter.grpc.client.inject
 * author:         Gavin.Xu
 * date:           2021/6/8
 */
public class GrpcClientBeanPostProcessor implements BeanPostProcessor {
    ...
    protected <T> T processInjectionPoint(final Member injectionTarget, final Class<T> injectionType,
        ...
        try {
            channel = getChannelFactory().createChannel(name, version);
            if (channel == null) {
                throw new IllegalStateException("Channel factory created a null channel for " + name + ":" + version);
            }
